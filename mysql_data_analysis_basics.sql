...
-- Task 3:Lucky Shrub needs to analyze the sales performance of their Patio slates product in the year 2021. This product has a Product ID of P3. Help Lucky Shrub to analyze the performance of this product by developing a function called FindSoldQuantity that enables them to: Input a ProductID and a year from which they can capture data. And display the total quantity of the product sold in the given year.
